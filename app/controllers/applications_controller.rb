class ApplicationsController < ApplicationController
  ...
  private
    ...
    def application_params
      params.require(:application).permit(:company_name, :company_description, :website_url, :nif, :founding_team, :team_description, :email, :founding_date, :funding_to_date, :activity, :product_description, :customers, :business_model, :future, :pitch_url, :pitch_name, :temp_state)
    end
end
